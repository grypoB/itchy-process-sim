...
LowHighController::LowHighController() : Controller(), val_switch_high_(DEFAULT_SWITCH),
 ...
 * @see LowHighController::refresh
 */
LowHighController::LowHighController(State* pState, Server* pServer, double switch_high, 
...
LowHighController::~LowHighController() {}


/** Controller take the maximum value over a certain value and take the
 * minimum value under a certain value.
 */
double LowHighController::getResponse(double, double val_state, double) {
